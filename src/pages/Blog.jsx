    ...
    <Reveal delay={(index % 6) * 60}>
      ...
      >
        ...
        >
          ...
          <p
            className={`mt-3 flex-1 text-sm leading-relaxed text-steel ${
              featured
                ? 'line-clamp-3'
                : 'line-clamp-2'
            }`}
...
export default function Blog() {
  ...
  return (
    <div>
      ...
      <section className="border-b border-line bg-white/80 py-6 backdrop-blur lg:sticky lg:top-[80px] lg:z-30">
            ...
            <button
              ...
              className={`rounded-full border px-3.5 py-1.5 text-xs font-semibold transition-colors ${
                !activeTag
                  ...
                  : 'border-line bg-white text-steel hover:border-teal/40 hover:text-teal-dark'
              }`}
            >
              All Topics
            </button>
