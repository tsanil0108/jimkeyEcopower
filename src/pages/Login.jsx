      ...
      <div className="w-full max-w-md rounded-2xl border border-line bg-white p-8 shadow-sm sm:p-10">
        ...
        <form className="mt-8 space-y-4" onSubmit={(e) => e.preventDefault()}>
          <div className="relative">
            ...
            <input required type="email" placeholder="Email or Username" className="w-full rounded-lg border border-line py-3 pl-11 pr-4 text-sm outline-none focus:border-teal" />
          </div>
          <div className="relative">
            <Lock className="absolute left-3.5 top-3.5 text-steel" size={18} />
            <input required type="password" placeholder="Password" className="w-full rounded-lg border border-line py-3 pl-11 pr-4 text-sm outline-none focus:border-teal" />
          </div>
          ...
          <Button as="button" className="w-full">Login</Button>
        </form>
